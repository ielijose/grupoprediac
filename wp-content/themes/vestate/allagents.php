 ...
 * FILE: allagents.php 
 * Created on Aug 16, 2013 at 1:50:39 PM 
 * Author: Mr.Vibe 
                    ...
                    <?php
                           ...
                           while (have_posts()) : the_post(); 
                            ...
                            <?php
                             ...
                             query_posts('post_type=agent&posts_per_page='.$number.'&paged='.$paged);
                            ?>
                        ...
                        <div class="vibe_post_grid ">
                            <div class="vibe_grid  masonry">
                                ...
                                <div class="vibe_grid masonry" data-paged="<?php echo $paged; ?>">
                                     <ul class="grid masonry" data-width="440" data-gutter="20">
                        <?php
                            if (have_posts()) : 
                            while (have_posts()) : the_post(); 
                            global $post;
                                ...
                                echo '<li class="medium grid-item" style="width:440px;margin-bottom:20px;">';

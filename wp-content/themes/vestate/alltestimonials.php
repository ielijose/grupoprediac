 ...
 * Created on Jul 18, 2013 at 12:59:59 PM 
 * Author: Mr.Vibe 
                    ...
                    <?php
                           ...
                           while (have_posts()) : the_post(); 
                            ...
                            <?php
                             ...
                             query_posts('post_type=testimonials&posts_per_page='.$number.'&paged='.$paged);
                            ?>
                        ...
                        <div class="vibe_post_grid ">
                            <div class="vibe_grid  masonry">
                                ...
                                <div class="vibe_grid masonry" data-paged="<?php echo $paged; ?>">
                                     <ul class="grid masonry" data-width="292" data-gutter="20">
                        <?php
                            if (have_posts()) : 
                            while (have_posts()) : the_post(); 
                            global $post;
                                ...
                                if(strlen($post->post_content) > $n)
                                    $read_more= '<a href="'.get_permalink($post->ID).'" class="primary"><small>'.$more.'</small></a>';
    
    
                                echo '<li class="medium grid-item" style="width:292px;margin-bottom:20px;">';
                                echo '<div class="block">
                                        <div class="block_media">';
                                echo featured_component($post->ID,$cols);
                                echo '</div><div class="block_content">';
                                echo '<h4 class="block_title"><a href="'.get_permalink($post->ID).'" title="'.$post->post_title.'">'.$post->post_title.'</a></h4>';

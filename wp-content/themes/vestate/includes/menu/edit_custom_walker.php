	...
	function start_el(&$output, $item, $depth =0, $args=array(),$id=0) {
	    ...
	    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
	            ...
	            <p class="field-custom description description-wide sidebar select-sidebar  <?php if(strlen($item->sidebar)>3)echo 'active'; ?>">
                    ...
                    <p class="field-custom description description-thin sidebar sidebar-columns  <?php if(strlen($item->sidebar)>3)echo 'active'; ?>">

       ...
       ?>
        <form class="standard-form vibe-front-form"  method="post" action=""  enctype="multipart/form-data">
            ...
            <?php endif;?>
             ...
             <label for="vibe_front_title"><?php _e('Agent Profile Title','vibe');?></label>
                <input type="text" name="vibe_front_title"  value="<?php echo $title;?>"/>
             
            
             <label for="vibe_front_text" ><?php _e('Agent Profile Description','vibe');?> </label>
           ...
           <?php echo "<div class='simple-post-custom-fields'>";?>     
                <h3><?php _e('Agent Information','vibe'); ?></h3>
           ...
           <?php endif;?>     
            ...
            <?php
              ...
              if(isset($post_id))
                  $button=__('Edit Agent Profile','vibe');
              else  
                $button=__('Add Agent Profile','vibe');
